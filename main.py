...
__CHANNEL_USERNAME__ = "alphahackteams"
__GROUP_USERNAME__   = "alphahackteamschat"
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](18):[/cyan] [green]Unlock House All ~ 2500[/green]")
            console.print("[bold][cyan](19):[/cyan] [green]Unlock Smokes ~ 2000[/green]")
            ...
            console.print("[bold][cyan](22):[/cyan] [green]Hack Car Speed ~ 3000[/green]")
            console.print("[bold][cyan](23):[/cyan] [green]Hack All Cars Speed ~ 3000[/green]")
            console.print("[bold][cyan](24):[/cyan] [green]Clone Account ~ 4000[/green]")
            ...
            if service == 0: # Exit
                ...
                if amount > 0 and amount <= 10000000:
                    ...
                    sleep(2)
                    continue
            elif service == 22: # Hack Car Speed
                console.print("[bold cyan][!] Insert Car ID[/bold cyan]")
                car_id = IntPrompt.ask("[bold][?] CarID[/bold]")
                console.print("[bold cyan][%] Saving your data[/bold cyan]: ", end=None)
                if null > 0 and null <= 0:
